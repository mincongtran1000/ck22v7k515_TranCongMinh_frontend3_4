...
<div class="form-group">
<button class="border btn btn-success">Lưu</button>
<button v-if="contactLocal._id" type="button" class="border ml-2 btn btn-danger"
@click="deleteContact">Xóa
</button>
<button type="button" class="border ml-2 btn btn-dark" @click="Cancel">Cancel
</button>
</div>
</Form>
</template>
